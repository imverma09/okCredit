  ...
  return (
    <div>
      <nav className="border-2 py-3 px-12 flex justify-between">
        ...
        <div>
          <span className="px-12 py-1 text-lg cursor-pointer bg-gray-50 ">Sign up</span>
          <span className="px-12 mx-4 py-1 text-lg cursor-pointer bg-gray-50 ">Sign in</span>
        </div>
      </nav>
      <nav className=" px-12 flex justify-between mt-5">
        ...
        <div>
          ...
          {
            <button className='border-gray-50 bg-gray-50 border-2 px-6 ml-2' onClick={() => {
