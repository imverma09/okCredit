      ...
      <div className="w-5/6 lg:w-1/2 mx-auto bg-white rounded shadow">
        ...
        <div className="py-4 px-8">
          <div className="mb-4">
            ...
            <input className=" border rounded w-full py-2 px-3 text-grey-darker" id="email" type="email" value={loginData.email} onChange={changeHandler} placeholder="Your email address"/>
          </div>
          <div className="mb-4">
            <label className="block text-grey-darker text-sm font-bold mb-2" htmlFor="password">Password *</label>
            <input className=" border rounded w-full py-2 px-3 text-grey-darker" id="password" type="password" value={loginData.password} onChange={changeHandler} placeholder="Your secure password"/>
          </div>
